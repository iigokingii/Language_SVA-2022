...
#define	TS(n) Rule::Chain::T(n)
	Greibach greibach(NS('S'), TS('$'),
		...
		//Rule(NS('P'), GRB_ERROR_SERIES + 9,		// не найден список параметров функции TODO
		//	2,//P->() | (G)
		//	Rule::Chain(2, TS('('), TS(')')),
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 1,		//ошибка в объявлении переменной	
			16,//N->dti;N | dti; | ?:M$A$ | ntfiG;N |  ntfiG | i=E(E)VE;N | i=E(E)VE; | ntiG;N | i=E; | i=E;N | i=E(E); | i=E(E);N
			...
			Rule::Chain(10, TS('i'), TS('='), TS('i'), TS('('), NS('E'), TS(')'), NS('V'), NS('E'), TS(';'), NS('N')),
			Rule::Chain(9, TS('i'), TS('='), TS('i'), TS('('), NS('E'), TS(')'), NS('V'), NS('E'), TS(';')),
			Rule::Chain(6, TS('n'), TS('t'), TS('i'), NS('G'), TS(';'), NS('N')),
			Rule::Chain(4, TS('i'), TS('='), NS('E'), TS(';')),
			Rule::Chain(5, TS('i'), TS('='), NS('E'), TS(';'), NS('N')),
			Rule::Chain(7, TS('i'), TS('='), NS('E'), TS('('), NS('E'), TS(')'), TS(';')),
			Rule::Chain(8, TS('i'), TS('='), NS('E'), TS('('), NS('E'), TS(')'), TS(';'),NS('N')),
